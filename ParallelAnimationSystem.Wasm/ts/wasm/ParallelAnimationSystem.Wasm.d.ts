...
interface WasmModule {
  ...
  _randomSeedService_setSeed(_0: number, _1: BigInt): void;
  _randomSeedService_getSeed(_0: number): BigInt;
  _main_getApp(): number;
  _main_shutdown(): void;
  _main_start(_0: number, _1: number): void;
  ...
  _beatmapThemeColorList_setAt(_0: number, _1: number, _2: number): void;
  _beatmapThemeColorList_fetchAt(_0: number, _1: number, _2: number): void;
  _beatmapThemeColorList_getCount(_0: number): number;
  _beatmapTheme_getParallaxObjectColors(_0: number): number;
  _beatmapTheme_getEffectColors(_0: number): number;
  _beatmapTheme_getObjectColors(_0: number): number;
  _beatmapTheme_getPlayerColors(_0: number): number;
  _beatmapTheme_setGuiAccentColor(_0: number, _1: number): void;
  _beatmapTheme_getGuiAccentColor(_0: number, _1: number): void;
  _beatmapTheme_setGuiColor(_0: number, _1: number): void;
  _beatmapTheme_getGuiColor(_0: number, _1: number): void;
  _beatmapTheme_setBackgroundColor(_0: number, _1: number): void;
  _beatmapTheme_getBackgroundColor(_0: number, _1: number): void;
  _beatmapTheme_setName(_0: number, _1: number): void;
  _beatmapTheme_getName(_0: number): number;
  _beatmapTheme_getId(_0: number): number;
  _beatmapTheme_new(_0: number): number;
  _beatmapService_loadBeatmap(_0: number, _1: number, _2: number): void;
  _beatmapService_getBeatmapFormat(_0: number): number;
  _beatmapService_getBeatmapData(_0: number): number;
  ...
  _app_getBeatmapService(_0: number): number;
  _app_getRandomSeedService(_0: number): number;
}
