...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("ParallelAnimationSystem.Wasm.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("ParallelAnimationSystem.Wasm.wasm", import.meta.url).href;
}
...
var LE_ATOMICS_WAIT = (heap, offset, value, timeout = Infinity) => {
  const order = LE_ATOMICS_NATIVE_BYTE_ORDER[heap.BYTES_PER_ELEMENT - 1];
  return Atomics.wait(heap, offset, order(value), timeout);
};

var LE_ATOMICS_WAITASYNC = (heap, offset, value, timeout = Infinity) => {
  const order = LE_ATOMICS_NATIVE_BYTE_ORDER[heap.BYTES_PER_ELEMENT - 1];
...
var SYSCALLS = {
  ...
  writeStat(buf, stat) {
    LE_HEAP_STORE_U32(((buf) >> 2) * 4, stat.dev);
    LE_HEAP_STORE_U32((((buf) + (4)) >> 2) * 4, stat.mode);
    LE_HEAP_STORE_U32((((buf) + (8)) >> 2) * 4, stat.nlink);
    LE_HEAP_STORE_U32((((buf) + (12)) >> 2) * 4, stat.uid);
    LE_HEAP_STORE_U32((((buf) + (16)) >> 2) * 4, stat.gid);
    LE_HEAP_STORE_U32((((buf) + (20)) >> 2) * 4, stat.rdev);
    LE_HEAP_STORE_I64((((buf) + (24)) >> 3) * 8, BigInt(stat.size));
    LE_HEAP_STORE_I32((((buf) + (32)) >> 2) * 4, 4096);
    LE_HEAP_STORE_I32((((buf) + (36)) >> 2) * 4, stat.blocks);
    var atime = stat.atime.getTime();
    var mtime = stat.mtime.getTime();
    var ctime = stat.ctime.getTime();
    LE_HEAP_STORE_I64((((buf) + (40)) >> 3) * 8, BigInt(Math.floor(atime / 1e3)));
    LE_HEAP_STORE_U32((((buf) + (48)) >> 2) * 4, (atime % 1e3) * 1e3 * 1e3);
    LE_HEAP_STORE_I64((((buf) + (56)) >> 3) * 8, BigInt(Math.floor(mtime / 1e3)));
    LE_HEAP_STORE_U32((((buf) + (64)) >> 2) * 4, (mtime % 1e3) * 1e3 * 1e3);
    LE_HEAP_STORE_I64((((buf) + (72)) >> 3) * 8, BigInt(Math.floor(ctime / 1e3)));
    LE_HEAP_STORE_U32((((buf) + (80)) >> 2) * 4, (ctime % 1e3) * 1e3 * 1e3);
    LE_HEAP_STORE_I64((((buf) + (88)) >> 3) * 8, BigInt(stat.ino));
    return 0;
  },
  writeStatFs(buf, stats) {
    LE_HEAP_STORE_U32((((buf) + (4)) >> 2) * 4, stats.bsize);
    LE_HEAP_STORE_U32((((buf) + (60)) >> 2) * 4, stats.bsize);
    LE_HEAP_STORE_I64((((buf) + (8)) >> 3) * 8, BigInt(stats.blocks));
    LE_HEAP_STORE_I64((((buf) + (16)) >> 3) * 8, BigInt(stats.bfree));
    LE_HEAP_STORE_I64((((buf) + (24)) >> 3) * 8, BigInt(stats.bavail));
    LE_HEAP_STORE_I64((((buf) + (32)) >> 3) * 8, BigInt(stats.files));
    LE_HEAP_STORE_I64((((buf) + (40)) >> 3) * 8, BigInt(stats.ffree));
    LE_HEAP_STORE_U32((((buf) + (48)) >> 2) * 4, stats.fsid);
    LE_HEAP_STORE_U32((((buf) + (64)) >> 2) * 4, stats.flags);
    // ST_NOSUID
    LE_HEAP_STORE_U32((((buf) + (56)) >> 2) * 4, stats.namelen);
  },
...
var Browser = {
  ...
  setFullscreenCanvasSize() {
    ...
    if (typeof SDL != "undefined") {
      var flags = LE_HEAP_LOAD_U32(((SDL.screen) >> 2) * 4);
      flags = flags | 8388608;
      // set SDL_FULLSCREEN flag
      LE_HEAP_STORE_I32(((SDL.screen) >> 2) * 4, flags);
    }
...
var EGL = {
  ...
  chooseConfig(display, attribList, config, config_size, numConfigs) {
    ...
    if (attribList) {
      ...
      for (;;) {
        var param = LE_HEAP_LOAD_I32(((attribList) >> 2) * 4);
        if (param == 12321) {
          var alphaSize = LE_HEAP_LOAD_I32((((attribList) + (4)) >> 2) * 4);
          EGL.contextAttributes.alpha = (alphaSize > 0);
        } else if (param == 12325) {
          var depthSize = LE_HEAP_LOAD_I32((((attribList) + (4)) >> 2) * 4);
          EGL.contextAttributes.depth = (depthSize > 0);
        } else if (param == 12326) {
          var stencilSize = LE_HEAP_LOAD_I32((((attribList) + (4)) >> 2) * 4);
          EGL.contextAttributes.stencil = (stencilSize > 0);
        } else if (param == 12337) {
          var samples = LE_HEAP_LOAD_I32((((attribList) + (4)) >> 2) * 4);
          EGL.contextAttributes.antialias = (samples > 0);
        } else if (param == 12338) {
          var samples = LE_HEAP_LOAD_I32((((attribList) + (4)) >> 2) * 4);
          EGL.contextAttributes.antialias = (samples == 1);
        } else if (param == 12544) {
          var requestedPriority = LE_HEAP_LOAD_I32((((attribList) + (4)) >> 2) * 4);
    ...
    if (numConfigs) {
      LE_HEAP_STORE_I32(((numConfigs) >> 2) * 4, 1);
    }
    if (config && config_size > 0) {
      LE_HEAP_STORE_U32(((config) >> 2) * 4, 62002);
    }
...
var GL = {
  ...
  genObject: (n, buffers, createFunction, objectTable) => {
    for (var i = 0; i < n; i++) {
      ...
      LE_HEAP_STORE_I32((((buffers) + (i * 4)) >> 2) * 4, id);
    }
  },
  getSource: (shader, count, string, length) => {
    var source = "";
    for (var i = 0; i < count; ++i) {
      var len = length ? LE_HEAP_LOAD_U32((((length) + (i * 4)) >> 2) * 4) : undefined;
      source += UTF8ToString(LE_HEAP_LOAD_U32((((string) + (i * 4)) >> 2) * 4), len);
    }
    return source;
  },
...
var _eglCreateContext = (display, config, hmm, contextAttribs) => {
  ...
  for (;;) {
    var param = LE_HEAP_LOAD_I32(((contextAttribs) >> 2) * 4);
    if (param == 12440) {
      glesContextVersion = LE_HEAP_LOAD_I32((((contextAttribs) + (4)) >> 2) * 4);
    } else if (param == 12344) {
      break;
    } else {
...
var _eglInitialize = (display, majorVersion, minorVersion) => {
  ...
  if (majorVersion) {
    LE_HEAP_STORE_I32(((majorVersion) >> 2) * 4, 1);
  }
  if (minorVersion) {
    LE_HEAP_STORE_I32(((minorVersion) >> 2) * 4, 4);
  }
...
var _eglQuerySurface = (display, surface, attribute, value) => {
  ...
  switch (attribute) {
   case 12328:
    // EGL_CONFIG_ID
    LE_HEAP_STORE_I32(((value) >> 2) * 4, 62002);
    return 1;
   ...
   case 12375:
    // EGL_WIDTH
    LE_HEAP_STORE_I32(((value) >> 2) * 4, Browser.getCanvas().width);
    return 1;

   case 12374:
    // EGL_HEIGHT
    LE_HEAP_STORE_I32(((value) >> 2) * 4, Browser.getCanvas().height);
    return 1;

   case 12432:
    // EGL_HORIZONTAL_RESOLUTION
    LE_HEAP_STORE_I32(((value) >> 2) * 4, -1);
    return 1;
   ...
   case 12422:
    ...
    LE_HEAP_STORE_I32(((value) >> 2) * 4, 12420);
    return 1;

   case 12441:
    // EGL_MULTISAMPLE_RESOLVE
    LE_HEAP_STORE_I32(((value) >> 2) * 4, 12442);
    return 1;
   ...
   case 12435:
    ...
    LE_HEAP_STORE_I32(((value) >> 2) * 4, 12437);
    return 1;
...
var _emscripten_glDeleteBuffers = (n, buffers) => {
  for (var i = 0; i < n; i++) {
    var id = LE_HEAP_LOAD_I32((((buffers) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDeleteFramebuffers = (n, framebuffers) => {
  for (var i = 0; i < n; ++i) {
    var id = LE_HEAP_LOAD_I32((((framebuffers) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDeleteQueries = (n, ids) => {
  for (var i = 0; i < n; i++) {
    var id = LE_HEAP_LOAD_I32((((ids) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDeleteRenderbuffers = (n, renderbuffers) => {
  for (var i = 0; i < n; i++) {
    var id = LE_HEAP_LOAD_I32((((renderbuffers) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDeleteSamplers = (n, samplers) => {
  for (var i = 0; i < n; i++) {
    var id = LE_HEAP_LOAD_I32((((samplers) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDeleteTextures = (n, textures) => {
  for (var i = 0; i < n; i++) {
    var id = LE_HEAP_LOAD_I32((((textures) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDeleteVertexArrays = (n, vaos) => {
  for (var i = 0; i < n; i++) {
    var id = LE_HEAP_LOAD_I32((((vaos) + (i * 4)) >> 2) * 4);
...
var _emscripten_glDrawBuffers = (n, bufs) => {
  ...
  for (var i = 0; i < n; i++) {
    bufArray[i] = LE_HEAP_LOAD_I32((((bufs) + (i * 4)) >> 2) * 4);
  }
...
var _emscripten_glGenQueriesEXT = (n, ids) => {
  for (var i = 0; i < n; i++) {
    ...
    if (!query) {
      GL.recordError(1282);
      while (i < n) LE_HEAP_STORE_I32((((ids) + (i++ * 4)) >> 2) * 4, 0);
      return;
    }
    var id = GL.getNewId(GL.queries);
    query.name = id;
    GL.queries[id] = query;
    LE_HEAP_STORE_I32((((ids) + (i * 4)) >> 2) * 4, id);
  }
};
...
var __glGetActiveAttribOrUniform = (funcName, program, index, bufSize, length, size, type, name) => {
  ...
  if (info) {
    ...
    if (length) LE_HEAP_STORE_I32(((length) >> 2) * 4, numBytesWrittenExclNull);
    if (size) LE_HEAP_STORE_I32(((size) >> 2) * 4, info.size);
    if (type) LE_HEAP_STORE_I32(((type) >> 2) * 4, info.type);
  }
};
...
var _emscripten_glGetActiveUniformBlockName = (program, uniformBlockIndex, bufSize, length, uniformBlockName) => {
  ...
  if (uniformBlockName && bufSize > 0) {
    ...
    if (length) LE_HEAP_STORE_I32(((length) >> 2) * 4, 0);
  }
};
...
var _emscripten_glGetActiveUniformBlockiv = (program, uniformBlockIndex, pname, params) => {
  ...
  if (pname == 35393) {
    ...
    LE_HEAP_STORE_I32(((params) >> 2) * 4, name.length + 1);
    return;
  }
  ...
  if (pname == 35395) {
    for (var i = 0; i < result.length; i++) {
      LE_HEAP_STORE_I32((((params) + (i * 4)) >> 2) * 4, result[i]);
    }
  } else {
    LE_HEAP_STORE_I32(((params) >> 2) * 4, result);
  }
};
...
var _emscripten_glGetActiveUniformsiv = (program, uniformCount, uniformIndices, pname, params) => {
  ...
  for (var i = 0; i < uniformCount; i++) {
    ids.push(LE_HEAP_LOAD_I32((((uniformIndices) + (i * 4)) >> 2) * 4));
  }
...
var _emscripten_glGetAttachedShaders = (program, maxCount, count, shaders) => {
  ...
  LE_HEAP_STORE_I32(((count) >> 2) * 4, len);
  for (var i = 0; i < len; ++i) {
    var id = GL.shaders.indexOf(result[i]);
    LE_HEAP_STORE_I32((((shaders) + (i * 4)) >> 2) * 4, id);
  }
};
...
var writeI53ToI64 = (ptr, num) => {
  LE_HEAP_STORE_U32(((ptr) >> 2) * 4, num);
  var lower = LE_HEAP_LOAD_U32(((ptr) >> 2) * 4);
  LE_HEAP_STORE_U32((((ptr) + (4)) >> 2) * 4, (num - lower) / 4294967296);
};
...
var emscriptenWebGLGet = (name_, p, type) => {
     ...
     case "object":
      if (result === null) {
        ...
        for (var i = 0; i < result.length; ++i) {
          switch (type) {
           case 0:
            LE_HEAP_STORE_I32((((p) + (i * 4)) >> 2) * 4, result[i]);
            break;

           case 2:
            LE_HEAP_STORE_F32((((p) + (i * 4)) >> 2) * 4, result[i]);
            break;
  ...
  switch (type) {
   ...
   case 0:
    LE_HEAP_STORE_I32(((p) >> 2) * 4, ret);
    break;

   case 2:
    LE_HEAP_STORE_F32(((p) >> 2) * 4, ret);
    break;
...
var _emscripten_glGetBufferParameteriv = (target, value, data) => {
  ...
  LE_HEAP_STORE_I32(((data) >> 2) * 4, GLctx.getBufferParameter(target, value));
};
...
var emscriptenWebGLGetIndexed = (target, index, data, type) => {
  ...
  switch (type) {
   ...
   case 0:
    LE_HEAP_STORE_I32(((data) >> 2) * 4, ret);
    break;

   case 2:
    LE_HEAP_STORE_F32(((data) >> 2) * 4, ret);
    break;
...
var _emscripten_glGetInternalformativ = (target, internalformat, pname, bufSize, params) => {
  ...
  for (var i = 0; i < ret.length && i < bufSize; ++i) {
    LE_HEAP_STORE_I32((((params) + (i * 4)) >> 2) * 4, ret[i]);
  }
};
...
var _emscripten_glGetProgramiv = (program, pname, p) => {
  ...
  if (pname == 35716) {
    ...
    if (log === null) log = "(unknown error)";
    LE_HEAP_STORE_I32(((p) >> 2) * 4, log.length + 1);
  } else if (pname == 35719) {
    ...
    LE_HEAP_STORE_I32(((p) >> 2) * 4, program.maxUniformLength);
  } else if (pname == 35722) {
    ...
    LE_HEAP_STORE_I32(((p) >> 2) * 4, program.maxAttributeLength);
  } else if (pname == 35381) {
    ...
    LE_HEAP_STORE_I32(((p) >> 2) * 4, program.maxUniformBlockNameLength);
  } else {
    LE_HEAP_STORE_I32(((p) >> 2) * 4, GLctx.getProgramParameter(program, pname));
  }
};
...
var _emscripten_glGetQueryObjectivEXT = (id, pname, params) => {
  ...
  LE_HEAP_STORE_I32(((params) >> 2) * 4, ret);
};
...
var _emscripten_glGetQueryiv = (target, pname, params) => {
  ...
  LE_HEAP_STORE_I32(((params) >> 2) * 4, GLctx.getQuery(target, pname));
};
...
var _emscripten_glGetQueryivEXT = (target, pname, params) => {
  ...
  LE_HEAP_STORE_I32(((params) >> 2) * 4, GLctx.disjointTimerQueryExt["getQueryEXT"](target, pname));
};
...
var _emscripten_glGetRenderbufferParameteriv = (target, pname, params) => {
  ...
  LE_HEAP_STORE_I32(((params) >> 2) * 4, GLctx.getRenderbufferParameter(target, pname));
};
...
var _emscripten_glGetSamplerParameterfv = (sampler, pname, params) => {
  ...
  LE_HEAP_STORE_F32(((params) >> 2) * 4, GLctx.getSamplerParameter(GL.samplers[sampler], pname));
};
...
var _emscripten_glGetSamplerParameteriv = (sampler, pname, params) => {
  ...
  LE_HEAP_STORE_I32(((params) >> 2) * 4, GLctx.getSamplerParameter(GL.samplers[sampler], pname));
};
...
var _emscripten_glGetShaderPrecisionFormat = (shaderType, precisionType, range, precision) => {
  ...
  LE_HEAP_STORE_I32(((range) >> 2) * 4, result.rangeMin);
  LE_HEAP_STORE_I32((((range) + (4)) >> 2) * 4, result.rangeMax);
  LE_HEAP_STORE_I32(((precision) >> 2) * 4, result.precision);
};
...
var _emscripten_glGetShaderiv = (shader, pname, p) => {
  ...
  if (pname == 35716) {
    ...
    LE_HEAP_STORE_I32(((p) >> 2) * 4, logLength);
  } else if (pname == 35720) {
    ...
    LE_HEAP_STORE_I32(((p) >> 2) * 4, sourceLength);
  } else {
    LE_HEAP_STORE_I32(((p) >> 2) * 4, GLctx.getShaderParameter(GL.shaders[shader], pname));
  }
};
...
var _emscripten_glGetSynciv = (sync, pname, bufSize, length, values) => {
  ...
  if (ret !== null) {
    LE_HEAP_STORE_I32(((values) >> 2) * 4, ret);
    if (length) LE_HEAP_STORE_I32(((length) >> 2) * 4, 1);
  }
};
...
var _emscripten_glGetTexParameterfv = (target, pname, params) => {
  ...
  LE_HEAP_STORE_F32(((params) >> 2) * 4, GLctx.getTexParameter(target, pname));
};
...
var _emscripten_glGetTexParameteriv = (target, pname, params) => {
  ...
  LE_HEAP_STORE_I32(((params) >> 2) * 4, GLctx.getTexParameter(target, pname));
};
...
var _emscripten_glGetUniformIndices = (program, uniformCount, uniformNames, uniformIndices) => {
  ...
  program = GL.programs[program];
  var names = [];
  for (var i = 0; i < uniformCount; i++) names.push(UTF8ToString(LE_HEAP_LOAD_U32((((uniformNames) + (i * 4)) >> 2) * 4)));
  var result = GLctx.getUniformIndices(program, names);
  if (!result) return;
  // GL spec: If an error is generated, nothing is written out to uniformIndices.
  var len = result.length;
  for (var i = 0; i < len; i++) {
    LE_HEAP_STORE_I32((((uniformIndices) + (i * 4)) >> 2) * 4, result[i]);
  }
};
...
/** @suppress{checkTypes} */ var emscriptenWebGLGetUniform = (program, location, params, type) => {
  ...
  if (typeof data == "number" || typeof data == "boolean") {
    switch (type) {
     case 0:
      LE_HEAP_STORE_I32(((params) >> 2) * 4, data);
      break;

     case 2:
      LE_HEAP_STORE_F32(((params) >> 2) * 4, data);
      break;
    }
  } else {
    for (var i = 0; i < data.length; i++) {
      switch (type) {
       case 0:
        LE_HEAP_STORE_I32((((params) + (i * 4)) >> 2) * 4, data[i]);
        break;

       case 2:
        LE_HEAP_STORE_F32((((params) + (i * 4)) >> 2) * 4, data[i]);
        break;
      }
    }
  }
...
/** @suppress{checkTypes} */ var emscriptenWebGLGetVertexAttrib = (index, pname, params, type) => {
  ...
  if (pname == 34975) {
    LE_HEAP_STORE_I32(((params) >> 2) * 4, data && data["name"]);
    ...
    switch (type) {
     ...
     case 5:
      LE_HEAP_STORE_I32(((params) >> 2) * 4, Math.fround(data));
      break;
    }
  } else {
    for (var i = 0; i < data.length; i++) {
      switch (type) {
       ...
       case 5:
        LE_HEAP_STORE_I32((((params) + (i * 4)) >> 2) * 4, Math.fround(data[i]));
        break;
      }
    }
  }
...
var _emscripten_glGetVertexAttribPointerv = (index, pname, pointer) => {
  ...
  LE_HEAP_STORE_I32(((pointer) >> 2) * 4, GLctx.getVertexAttribOffset(index, pname));
};
...
var _emscripten_glInvalidateFramebuffer = (target, numAttachments, attachments) => {
  ...
  for (var i = 0; i < numAttachments; i++) {
    list[i] = LE_HEAP_LOAD_I32((((attachments) + (i * 4)) >> 2) * 4);
  }
...
var _emscripten_glSamplerParameterfv = (sampler, pname, params) => {
  var param = LE_HEAP_LOAD_F32(((params) >> 2) * 4);
  GLctx.samplerParameterf(GL.samplers[sampler], pname, param);
};
...
var _emscripten_glSamplerParameteriv = (sampler, pname, params) => {
  var param = LE_HEAP_LOAD_I32(((params) >> 2) * 4);
  GLctx.samplerParameteri(GL.samplers[sampler], pname, param);
};
...
var _emscripten_glTransformFeedbackVaryings = (program, count, varyings, bufferMode) => {
  program = GL.programs[program];
  var vars = [];
  for (var i = 0; i < count; i++) vars.push(UTF8ToString(LE_HEAP_LOAD_U32((((varyings) + (i * 4)) >> 2) * 4)));
...
var _emscripten_glVertexAttrib4fv = (index, v) => {
  GLctx.vertexAttrib4f(index, LE_HEAP_LOAD_F32((v >> 2) * 4), LE_HEAP_LOAD_F32((v + 4 >> 2) * 4), LE_HEAP_LOAD_F32((v + 8 >> 2) * 4), LE_HEAP_LOAD_F32((v + 12 >> 2) * 4));
};
...
var _emscripten_glVertexAttribI4iv = (index, v) => {
  GLctx.vertexAttribI4i(index, LE_HEAP_LOAD_I32((v >> 2) * 4), LE_HEAP_LOAD_I32((v + 4 >> 2) * 4), LE_HEAP_LOAD_I32((v + 8 >> 2) * 4), LE_HEAP_LOAD_I32((v + 12 >> 2) * 4));
};
...
var _emscripten_glVertexAttribI4uiv = (index, v) => {
  GLctx.vertexAttribI4ui(index, LE_HEAP_LOAD_U32((v >> 2) * 4), LE_HEAP_LOAD_U32((v + 4 >> 2) * 4), LE_HEAP_LOAD_U32((v + 8 >> 2) * 4), LE_HEAP_LOAD_U32((v + 12 >> 2) * 4));
};
...
var _environ_get = (__environ, environ_buf) => {
  ...
  for (var string of getEnvStrings()) {
    ...
    LE_HEAP_STORE_U32((((__environ) + (envp)) >> 2) * 4, ptr);
...
function _fd_seek(fd, offset, whence, newOffset) {
  ...
  try {
    ...
    LE_HEAP_STORE_I64(((newOffset) >> 3) * 8, BigInt(stream.position));
...
function RhpGetCurrentBrowserThreadStackTrace(pShadowStack, pOutputBuffer, allFramesAsJS) {
  ...
  for (let currentIndex = 0, currentFrameEndIndex; currentIndex < jsStackTrace.length; currentIndex = currentFrameEndIndex + 1) {
    ...
    if (currentFrameEndIndex < 0) currentFrameEndIndex = jsStackTrace.length;
    ...
    if (wasmFuncStartIndex < 0 && actualBufferLength === 0) continue;
    if (wasmFuncStartIndex >= 0 && currentFrame.endsWith(callerModuleId, wasmFuncStartIndex) && !allFramesAsJS) {
      ...
      if (!isMeasurementPhase) {
        ...
        Module.HEAP32[pOutputBuffer >>> 2] = wasmFunctionIndex;
...
function RhpInitializeStackTraceIpMap(pEntries, count) {
  const POINTER_SIZE = 4;
  for (let i = 0; i < count; i++) {
    const fptr = Module.HEAP32[pEntries >>> 2];
    const func = wasmTable.get(fptr);
    let wasmFuncIndex = parseInt(func.name) + 2;
    if (isNaN(wasmFuncIndex)) wasmFuncIndex = 0;
...
function RhpGetBiasedWasmFunctionIndexForFunctionPointer(fptr) {
  const func = wasmTable.get(fptr);
  let wasmFuncIndex = parseInt(func.name) + 2;
  if (isNaN(wasmFuncIndex)) wasmFuncIndex = 0;
...
var _malloc, _string_getBytes, _string_getByteCount, _string_getLength, _randomSeedService_setSeed, _randomSeedService_getSeed, _main_getApp, _main_shutdown, _main_start, _keyframeList_load, _keyframeList_fetchRange, _keyframeList_getBufferSize, _keyframeList_fetchAt, _keyframeList_getKeyframeSize, _keyframeList_getCount, _keyframe_getEase, _keyframe_getTime, _keyframe_getType, _idContainer_iterator_dispose, _idContainer_iterator_getCurrent_value, _idContainer_iterator_getCurrent_key, _idContainer_iterator_reset, _idContainer_iterator_moveNext, _idContainer_getIterator, _idContainer_remove, _idContainer_insert, _idContainer_getById, _idContainer_getCount, _interop_free, _interop_alloc, _interop_releasePointer, _beatmapThemeColorList_setAt, _beatmapThemeColorList_fetchAt, _beatmapThemeColorList_getCount, _beatmapTheme_getParallaxObjectColors, _beatmapTheme_getEffectColors, _beatmapTheme_getObjectColors, _beatmapTheme_getPlayerColors, _beatmapTheme_setGuiAccentColor, _beatmapTheme_getGuiAccentColor, _beatmapTheme_setGuiColor, _beatmapTheme_getGuiColor, _beatmapTheme_setBackgroundColor, _beatmapTheme_getBackgroundColor, _beatmapTheme_setName, _beatmapTheme_getName, _beatmapTheme_getId, _beatmapTheme_new, _beatmapService_loadBeatmap, _beatmapService_getBeatmapFormat, _beatmapService_getBeatmapData, _beatmapPrefabInstance_setPrefabId, _beatmapPrefabInstance_getPrefabId, _beatmapPrefabInstance_setRotation, _beatmapPrefabInstance_getRotation, _beatmapPrefabInstance_setScale, _beatmapPrefabInstance_getScale, _beatmapPrefabInstance_setPosition, _beatmapPrefabInstance_getPosition, _beatmapPrefabInstance_setStartTime, _beatmapPrefabInstance_getStartTime, _beatmapPrefabInstance_getId, _beatmapPrefabInstance_new, _beatmapPrefab_getObjects, _beatmapPrefab_setOffset, _beatmapPrefab_getOffset, _beatmapPrefab_setName, _beatmapPrefab_getName, _beatmapPrefab_getId, _beatmapPrefab_new, _beatmapObject_getColorKeyframes, _beatmapObject_getRotationKeyframes, _beatmapObject_getScaleKeyframes, _beatmapObject_getPositionKeyframes, _beatmapObject_setText, _beatmapObject_getText, _beatmapObject_setCustomShapeInfo, _beatmapObject_getCustomShapeInfo, _beatmapObject_setShape, _beatmapObject_getShape, _beatmapObject_setAutoKillOffset, _beatmapObject_getAutoKillOffset, _beatmapObject_setAutoKillType, _beatmapObject_getAutoKillType, _beatmapObject_setStartTime, _beatmapObject_getStartTime, _beatmapObject_setRenderDepth, _beatmapObject_getRenderDepth, _beatmapObject_setOrigin, _beatmapObject_getOrigin, _beatmapObject_setRenderType, _beatmapObject_getRenderType, _beatmapObject_setParentOffset, _beatmapObject_getParentOffset, _beatmapObject_setParentType, _beatmapObject_getParentType, _beatmapObject_setType, _beatmapObject_getType, _beatmapObject_setParentId, _beatmapObject_getParentId, _beatmapObject_setName, _beatmapObject_getName, _beatmapObject_getId, _beatmapObject_new, _beatmapEvents_getHue, _beatmapEvents_getGlitch, _beatmapEvents_getGradient, _beatmapEvents_getGrain, _beatmapEvents_getLensDistortion, _beatmapEvents_getVignette, _beatmapEvents_getBloom, _beatmapEvents_getChroma, _beatmapEvents_getTheme, _beatmapEvents_getCameraShake, _beatmapEvents_getCameraRotation, _beatmapEvents_getCameraScale, _beatmapEvents_getCameraPosition, _beatmapData_clear, _beatmapData_getEvents, _beatmapData_getThemes, _beatmapData_getPrefabs, _beatmapData_getPrefabInstances, _beatmapData_getObjects, _app_processFrame, _app_getBeatmapService, _app_getRandomSeedService, _emscripten_builtin_memalign, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
  _malloc = wasmExports["malloc"];
  _string_getBytes = Module["_string_getBytes"] = wasmExports["string_getBytes"];
  _string_getByteCount = Module["_string_getByteCount"] = wasmExports["string_getByteCount"];
  _string_getLength = Module["_string_getLength"] = wasmExports["string_getLength"];
  _randomSeedService_setSeed = Module["_randomSeedService_setSeed"] = wasmExports["randomSeedService_setSeed"];
  _randomSeedService_getSeed = Module["_randomSeedService_getSeed"] = wasmExports["randomSeedService_getSeed"];
  _main_getApp = Module["_main_getApp"] = wasmExports["main_getApp"];
  _main_shutdown = Module["_main_shutdown"] = wasmExports["main_shutdown"];
  _main_start = Module["_main_start"] = wasmExports["main_start"];
  _keyframeList_load = Module["_keyframeList_load"] = wasmExports["keyframeList_load"];
  _keyframeList_fetchRange = Module["_keyframeList_fetchRange"] = wasmExports["keyframeList_fetchRange"];
  _keyframeList_getBufferSize = Module["_keyframeList_getBufferSize"] = wasmExports["keyframeList_getBufferSize"];
  _keyframeList_fetchAt = Module["_keyframeList_fetchAt"] = wasmExports["keyframeList_fetchAt"];
  _keyframeList_getKeyframeSize = Module["_keyframeList_getKeyframeSize"] = wasmExports["keyframeList_getKeyframeSize"];
  _keyframeList_getCount = Module["_keyframeList_getCount"] = wasmExports["keyframeList_getCount"];
  _keyframe_getEase = Module["_keyframe_getEase"] = wasmExports["keyframe_getEase"];
  _keyframe_getTime = Module["_keyframe_getTime"] = wasmExports["keyframe_getTime"];
  _keyframe_getType = Module["_keyframe_getType"] = wasmExports["keyframe_getType"];
  ...
  _idContainer_iterator_reset = Module["_idContainer_iterator_reset"] = wasmExports["idContainer_iterator_reset"];
  ...
  _beatmapThemeColorList_setAt = Module["_beatmapThemeColorList_setAt"] = wasmExports["beatmapThemeColorList_setAt"];
  _beatmapThemeColorList_fetchAt = Module["_beatmapThemeColorList_fetchAt"] = wasmExports["beatmapThemeColorList_fetchAt"];
  _beatmapThemeColorList_getCount = Module["_beatmapThemeColorList_getCount"] = wasmExports["beatmapThemeColorList_getCount"];
  _beatmapTheme_getParallaxObjectColors = Module["_beatmapTheme_getParallaxObjectColors"] = wasmExports["beatmapTheme_getParallaxObjectColors"];
  _beatmapTheme_getEffectColors = Module["_beatmapTheme_getEffectColors"] = wasmExports["beatmapTheme_getEffectColors"];
  _beatmapTheme_getObjectColors = Module["_beatmapTheme_getObjectColors"] = wasmExports["beatmapTheme_getObjectColors"];
  _beatmapTheme_getPlayerColors = Module["_beatmapTheme_getPlayerColors"] = wasmExports["beatmapTheme_getPlayerColors"];
  _beatmapTheme_setGuiAccentColor = Module["_beatmapTheme_setGuiAccentColor"] = wasmExports["beatmapTheme_setGuiAccentColor"];
  _beatmapTheme_getGuiAccentColor = Module["_beatmapTheme_getGuiAccentColor"] = wasmExports["beatmapTheme_getGuiAccentColor"];
  _beatmapTheme_setGuiColor = Module["_beatmapTheme_setGuiColor"] = wasmExports["beatmapTheme_setGuiColor"];
  _beatmapTheme_getGuiColor = Module["_beatmapTheme_getGuiColor"] = wasmExports["beatmapTheme_getGuiColor"];
  _beatmapTheme_setBackgroundColor = Module["_beatmapTheme_setBackgroundColor"] = wasmExports["beatmapTheme_setBackgroundColor"];
  _beatmapTheme_getBackgroundColor = Module["_beatmapTheme_getBackgroundColor"] = wasmExports["beatmapTheme_getBackgroundColor"];
  _beatmapTheme_setName = Module["_beatmapTheme_setName"] = wasmExports["beatmapTheme_setName"];
  _beatmapTheme_getName = Module["_beatmapTheme_getName"] = wasmExports["beatmapTheme_getName"];
  _beatmapTheme_getId = Module["_beatmapTheme_getId"] = wasmExports["beatmapTheme_getId"];
  _beatmapTheme_new = Module["_beatmapTheme_new"] = wasmExports["beatmapTheme_new"];
  _beatmapService_loadBeatmap = Module["_beatmapService_loadBeatmap"] = wasmExports["beatmapService_loadBeatmap"];
  _beatmapService_getBeatmapFormat = Module["_beatmapService_getBeatmapFormat"] = wasmExports["beatmapService_getBeatmapFormat"];
  _beatmapService_getBeatmapData = Module["_beatmapService_getBeatmapData"] = wasmExports["beatmapService_getBeatmapData"];
  ...
  _beatmapObject_getPositionKeyframes = Module["_beatmapObject_getPositionKeyframes"] = wasmExports["beatmapObject_getPositionKeyframes"];
  ...
  _beatmapObject_setCustomShapeInfo = Module["_beatmapObject_setCustomShapeInfo"] = wasmExports["beatmapObject_setCustomShapeInfo"];
  _beatmapObject_getCustomShapeInfo = Module["_beatmapObject_getCustomShapeInfo"] = wasmExports["beatmapObject_getCustomShapeInfo"];
  ...
  _beatmapEvents_getHue = Module["_beatmapEvents_getHue"] = wasmExports["beatmapEvents_getHue"];
  _beatmapEvents_getGlitch = Module["_beatmapEvents_getGlitch"] = wasmExports["beatmapEvents_getGlitch"];
  _beatmapEvents_getGradient = Module["_beatmapEvents_getGradient"] = wasmExports["beatmapEvents_getGradient"];
  _beatmapEvents_getGrain = Module["_beatmapEvents_getGrain"] = wasmExports["beatmapEvents_getGrain"];
  _beatmapEvents_getLensDistortion = Module["_beatmapEvents_getLensDistortion"] = wasmExports["beatmapEvents_getLensDistortion"];
  _beatmapEvents_getVignette = Module["_beatmapEvents_getVignette"] = wasmExports["beatmapEvents_getVignette"];
  _beatmapEvents_getBloom = Module["_beatmapEvents_getBloom"] = wasmExports["beatmapEvents_getBloom"];
  _beatmapEvents_getChroma = Module["_beatmapEvents_getChroma"] = wasmExports["beatmapEvents_getChroma"];
  _beatmapEvents_getTheme = Module["_beatmapEvents_getTheme"] = wasmExports["beatmapEvents_getTheme"];
  _beatmapEvents_getCameraShake = Module["_beatmapEvents_getCameraShake"] = wasmExports["beatmapEvents_getCameraShake"];
  _beatmapEvents_getCameraRotation = Module["_beatmapEvents_getCameraRotation"] = wasmExports["beatmapEvents_getCameraRotation"];
  _beatmapEvents_getCameraScale = Module["_beatmapEvents_getCameraScale"] = wasmExports["beatmapEvents_getCameraScale"];
  _beatmapEvents_getCameraPosition = Module["_beatmapEvents_getCameraPosition"] = wasmExports["beatmapEvents_getCameraPosition"];
  _beatmapData_clear = Module["_beatmapData_clear"] = wasmExports["beatmapData_clear"];
  _beatmapData_getEvents = Module["_beatmapData_getEvents"] = wasmExports["beatmapData_getEvents"];
  _beatmapData_getThemes = Module["_beatmapData_getThemes"] = wasmExports["beatmapData_getThemes"];
  ...
  _app_getBeatmapService = Module["_app_getBeatmapService"] = wasmExports["app_getBeatmapService"];
  _app_getRandomSeedService = Module["_app_getRandomSeedService"] = wasmExports["app_getRandomSeedService"];
...
var wasmImports = {
  /** @export */ RhpGetBiasedWasmFunctionIndexForFunctionPointer,
  /** @export */ RhpGetCurrentBrowserThreadStackTrace,
  /** @export */ RhpInitializeStackTraceIpMap,
